                                ...
                                <div class="supportTicket-single radius-10">
                                                ...
                                                <div class="supportTicket-single-chat">
                                                    <div class="supportTicket-single-chat-flex">
                                                        <div class="supportTicket-single-chat-thumb">
                                                            <img src="{{ get_attachment_image_by_id($message->admin_sender_or_default->image ?? '', 'thumb', true)['img_url'] }}"
                                                                alt="{{ __('admin') }}">
                                                        </div>
                                            ...
                                            @else
                                                <div class="supportTicket-single-chat reply">
                                                    <div class="supportTicket-single-chat-flex">
                                                        <div class="supportTicket-single-chat-thumb">
                                                            @if (cloudStorageExist() && in_array(Storage::getDefaultDriver(), ['s3', 'cloudFlareR2', 'wasabi']))
                                                                <img src="{{ render_frontend_cloud_image_if_module_exists('profile/' . $ticket_details?->client?->image, load_from: $ticket_details?->client?->load_from ?? '') }}"
                                                                    alt="{{ __('client') }}">
                                                            @else
                                                                <img src="{{ asset('assets/uploads/profile/' . $ticket_details->client?->image) }}"
                                                                    alt="{{ __('client') }}">
                                                            @endif
                                                        </div>
                                                        <div class="supportTicket-single-chat-contents">
                                    ...
                                    <div class="supportTicket-single-item">
                                        <div class="supportTicket-single-chat-replyForm">
                                            <x-validation.error />
                                            <form action="{{ route('client.ticket.details', $ticket_details->id) }}"
