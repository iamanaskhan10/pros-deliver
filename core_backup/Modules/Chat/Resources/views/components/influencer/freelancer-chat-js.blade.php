    ...
    */
    ...
    $(document).on("click","#freelancer-send-message-to-client", function (){
        ...
        if(messages_ != '' || file !== undefined){
            ...
            send_ajax_request("post", form, "{{ route("influencer.message.send") }}", function (){}, function (response){
    ...
    function fetch_chat_data(client_id, page = 1, callback){
        ...
        send_ajax_request("post", formData,`{{ route("influencer.fetch.chat.client.record") }}?page=${page}`,function (){
