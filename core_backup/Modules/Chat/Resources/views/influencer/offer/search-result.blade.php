                    ...
                    <div class="myOrder-single-flex">
                        <div class="myOrder-single-content">
                            <div class="d-flex gap-2 justify-content-between">
                                ...
                                <span class="myOrder-single-content-time inf-tag"><i class="fa-regular fa-clock"></i> {{ $offer->created_at->diffForHumans() }} </span>
                            </div>
                            <div class="myOrder-single-content-btn flex-btn mt-3">
                                ...
                                @endphp
                                @if($offer_order)
                                    <span class="job-progress inf-tag">{{ __('Accepted') }}</span>
                                @else
                                    <span class="pending-approval inf-tag">{{ __('Pending') }}</span>
                                    @if($offer->status == 0)
                ...
                <div class="myOrder-single-item">
                    <div class="myOrder-single-flex flex-between">
                        <div class="btn-wrapper flex-btn">
                            <a href="{{ route('influencer.offer.details',$offer->id) }}" class="inf-cmn-btn style2 md-radius btn-profile btn-bg-1">{{ __('View Offer') }}</a>
                        </div>
                    </div>
                </div>
            </div>
