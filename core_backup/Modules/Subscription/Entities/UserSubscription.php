...
class UserSubscription extends Model
{
    ...
    protected $fillable = ['user_id','subscription_id','price','limit','expire_date','payment_gateway','payment_status','status','transaction_id','manual_payment_image','email_send', 'stripe_customer_id',
        'stripe_subscription_id',
        'stripe_price_id', 'stripe_session_id', 'start_date', 'is_recurring_subscription'];
