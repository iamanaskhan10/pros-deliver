                ...
                <div class="customMarkup__single">
                    <div class="customMarkup__single__item">
                        ...
                        <div class="customMarkup__single__inner mt-4">
                            <x-notice.general-notice :class="'mt-5'" :description="__('Notice: When a new user register as a influencer by default he/she will get the welcome subscription. Once it is complete or expired he must buy subscription for sending campaign proposal or bid.')" />
