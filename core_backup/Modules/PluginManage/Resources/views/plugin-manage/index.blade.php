            ...
            <div class="col-md-12">
                <div class="recent-order-wrapper dashboard-table bg-white padding-30">
                    <div class="header-wrap">
                        ...
                        <p class="mb-2">{{__("Manage all plugins from here, you can active/deactivate plugin or can delete any plugin from here")}}</p>
                    </div>
    ...
    <script>
        (function ($){
            ...
            $(document).on("click",".pl_active_deactive",function(e){
                ...
                if(allData.status === 0 ){
                    var title = "{{__("Are you sure to activate")}}"
                }else{
                    var title = "{{__("Are you sure to deactivate")}}"
                }
                ...
                Swal.fire({
                    title: title + ' '+allData.plugin+" {{__("plugin ?")}}",
                    text:swalDesc,
                    icon: 'warning',
