    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">{{ __('Add Project Promotion Package') }}</h1>
            ...
            <form action="{{route('admin.project.promote.settings')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <x-form.active-inactive :title="__('Select Status')" :info="__('If you select inactive the Package will not be display publicly')" />
                </div>
