                        ...
                        <div class="customMarkup__single__inner mt-4">
                            <form action="{{ route('admin.general.settings.basic.save') }}" method="POST">
                                ...
                                <div class="switch mb-3">
                                    ...
                                    <input class="custom-switch" type="checkbox" id="site_maintenance_mode" name="site_maintenance_mode" @if(get_static_option('site_maintenance_mode') !== '') checked @endif id="site_maintenance_mode">
