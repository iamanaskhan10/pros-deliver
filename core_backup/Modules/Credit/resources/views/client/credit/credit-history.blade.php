...
@section('content')
    <main>
                        ...
                        <div class="profile-settings-wrapper">
                            ...
                            <div class="single-profile-settings" id="display_client_profile_photo">
                                <div class="single-profile-settings-flex">
                                    <div class="single-profile-settings-thumb">
                                        <h4 class="balance-wallet">{{ __('Credit:') }} <strong>{{ $creditBalance ?? 00 }}</strong></h4>
                                    </div>
                                    <div class="single-profile-settings-contents">
                                        <div class="single-profile-settings-contents-upload">
                                            <div class="single-profile-settings-contents-upload-btn">
                                                <button class="btn-profile btn-bg-1" data-bs-toggle="modal" data-bs-target="#creditPurchaseModal">{{ __('Buy Credit') }}</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="single-profile-settings" id="display_client_profile_info">
                                <div class="single-profile-settings-header">
                                    <x-validation.error />
                                    <x-notice.general-notice :description="__('Notice: Using credit balance, you can unlock influencer social link')" />
                                    <div class="single-profile-settings-header-flex">
                                        <x-form.form-title :title="__('Credit History')" :class="'single-profile-settings-header-title'" />
                                ...
                                <div class="single-profile-settings-inner profile-border-top">
                                    <div class="custom_table style-04 search_result">
                                        @include('credit::client.credit.search-result')
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <x-frontend.payment-gateway.credit-gateway-markup :title="__('Buy Credit')"/>
    </main>
@endsection

@section('script')
    @include('credit::client.credit.credit-js')
