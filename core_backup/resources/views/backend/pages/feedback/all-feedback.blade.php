...
@section('title', __('Influencer Feedbacks'))
@section('style')
    <x-media.css />
@endsection
@section('content')
        ...
        <div class="row">
            <div class="col-lg-12">
                <x-notice.general-notice
                        :description="__('Notice: This is a collection of influencer feedbacks. You can edit feedbacks here. Only approved feedbacks will be displayed on the frontend.')"
                        :description1="__('Notice: You can search by rating only.')"
                />
                <div class="customMarkup__single">
                    <div class="customMarkup__single__item">
                        <div class="customMarkup__single__item__flex">
                            <h4 class="customMarkup__single__title">{{ __('Influencer Feedbacks') }}</h4>
