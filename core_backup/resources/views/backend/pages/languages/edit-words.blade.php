                                ...
                                <div class="card-body">
                                    ...
                                    <div class="language-word-translate-box">
                                        <div class="search-box-wrapper">
                                            <input type="text" name="word_search" id="word_search" placeholder="{{__('Search Source or Translated Text...')}}">
                                        </div>
                                        <div class="top-part">
            ...
            $(document).ready(function (){
                ...
                $(document).on('keyup','#word_search',function (e){
                    ...
                    $.each(allSourceText,function (index,value){
                        ...
                        var translatedText = $(this).next().text();
                        var fullText = (sourceText + ' ' + translatedText).toLowerCase();
                        var found = fullText.includes(searchText.toLowerCase().trim());
                        if (!found){
                            $(this).parent().hide();
                        }else{
                            $(this).parent().show();
