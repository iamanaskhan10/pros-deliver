        ...
        <div id="notfound" class="notfound-wrapper">
            <div class="notfound">
                <div class="notfound-404">
                    <h1 class="notfound-wrapper-mainTitle">{{__('500')}}</h1>
                    <h3 class="notfound-wrapper-title">{{__('Server Errors')}}</h3>
                    <p class="notfound-wrapper-para">{{__('Please contact support')}}</p>
