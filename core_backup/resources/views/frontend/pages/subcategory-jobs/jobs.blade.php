...
@section('content')
    <main>
        ...
        <x-breadcrumb.user-profile-breadcrumb :title="__('Subcategory Campaigns') ?? __('Jobs')" :innerTitle=" $subcategory->sub_category ?? '' "/>
                            ...
                            <div class="shop-contents-wrapper responsive-lg">
                                ...
                                <div class="shop-contents-wrapper-right">
                                    <div class="jobFilter-wrapper-search">
                                        <input type="text" id="job_search_string" placeholder="{{ __('Search Campaigns...') }}" class="form--control">
