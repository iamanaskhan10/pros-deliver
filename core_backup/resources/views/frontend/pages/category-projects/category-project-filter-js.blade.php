        ...
        $(document).ready(function () {
            ...
            function projects(page=1){
                ...
                $.ajax({
                    ...
                    method:'GET',
                    data:{category:category,gender:gender,country:country,level:level,min_price:min_price,max_price:max_price,delivery_day:delivery_day,rating:rating,get_pro_projects:get_pro_projects,job_search_string:job_search_string},
