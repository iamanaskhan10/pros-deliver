<script>
    (function ($) {
        ...
        $(document).ready(function () {
            ...
            //search by country
            $(document).on('change', '#gender, #country , #level , #delivery_day', function() {
                projects();
            });
            $(document).on('click', '#set_price_range', function() {
                ...
                if(min_price && max_price){
                    ...
                    toastr_warning_js("{{__('Please select both price field')}}");
                    return false;
                }
            });
            ...
            function projects(page = 1){
                ...
                $.ajax({
                    ...
                    method:'GET',
                    data:{subcategory_id:subcategory_id,gender:gender,country:country,level:level,min_price:min_price,max_price:max_price,delivery_day:delivery_day,rating:rating,get_pro_projects:get_pro_projects,job_search_string:job_search_string},
