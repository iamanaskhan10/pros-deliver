            ...
            <div class="inf-project-card">
                <div class="top-part">
                    <div class="img-wraper">
                        <a href="{{ route('shake.details', ['username' => $project->project_creator?->username, 'slug' => $project->slug]) }}"
                           class="d-block">
                            @php
                                ...
                                // Get video path from media_uploads table
                                $videoPath = null;
                                if (!empty($project->video)) {
                                    $media = \App\Models\MediaUpload::find($project->video);
                                    if ($media) {
                                        $videoPath = 'assets/uploads/media-uploader/' . $media->path;
                                    }
                                }
                            @endphp
                        ...
                        @if(moduleExists('PromoteInfluencer') && $project->is_pro_project)
                    ...
                    <div class="text-part mt-4">
                        <div class="text-top">
                            <div class="infulencer">
                                ...
                                <div class="inf-name">
                                    <a
                                        href="{{ route('influencer.profile.details', $project->project_creator?->username) }}">
