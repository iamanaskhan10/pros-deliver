<div class="modal fade" id="reportModal" tabindex="-1" aria-labelledby="reportModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form action="{{ route('influencer.order.report') }}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer flex-column">
                    <div>
                        ...
                        <x-btn.submit :title="__('Submit')" :class="'btn-profile btn-bg-1 freelancer_order_report'" />
                    </div>
                </div>
            </div>
        </form>
