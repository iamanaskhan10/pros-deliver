...
@section('content')
    <main>
            ...
            <div class="container">
                ...
                <div class="timeTracker-wrapper">
                    <div class="timeTracker-item">
                        ...
                        <form action="{{ route('influencer.order.time.tracker',$order->id) }}" method="post">
                            @csrf
        ...
        @include('frontend.user.influencer.order.time-tracker.note-modal')
        @include('frontend.user.influencer.order.time-tracker.time-modal')
...
@section('script')
    ...
    @include('frontend.user.influencer.order.time-tracker.time-tracker-js')
@endsection
