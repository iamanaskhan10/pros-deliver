<div class="single-profile-settings border-all" id="display_freelancer_profile_info">
    ...
    <div class="single-profile-settings-inner profile-border-top">
        <div class="single-profile-settings-form custom-form">
            ...
            <div class="single-flex-input">
                ...
                <div class="single-input">
                    <label for="title" class="label-title">{{ __('Professional Title') }}</label>
                    <input value="{{ Auth::guard('web')->user()->github_id ?? '' }}" class="form-control" readonly disabled>
                </div>
            </div>
            <div class="single-input">
                <label for="title" class="label-title">{{ __('Your Phone') }}</label>
                <input value="{{ Auth::guard('web')->user()->phone ?? '' }}"
