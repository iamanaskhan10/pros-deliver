        ...
        <div class="create-project-intro-contents">
            <div class="create-project-intro-contents-form custom-form">
                ...
                <div class="single-input mt-3">
                    ...
                    <select name="category" id="category" class="form-control inf-custom-select category_select2">
               ...
               <x-form.text :title="__('What are you offering to clients?')" :type="'text'" :id="'project_title'" :name="'project_title'" :divClass="'mb-0'" :class="'form--control'" :value="$project_details->title ?? old('project_title')" :placeholder="__('You’ll create content, promote a product, or collaborate')" />
