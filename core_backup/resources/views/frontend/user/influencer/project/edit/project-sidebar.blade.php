<div class="setup-wrapper-left create-project border-all">
            ...
            <ul class="single-setup-request-list list-style-none">
                <li class="single-setup-request-list-item running">
                    ...
                    <div class="single-setup-request-list-item-contents">
                        <h5 class="single-setup-request-list-item-contents-title">{{ __('Shake Intro ') }}</h5>
                        <p class="single-setup-request-list-item-contents-para">{{ __('Add title & description to your shake ') }}</p>
                    </div>
                </li>
                <li class="single-setup-request-list-item">
                    <span class="single-setup-request-list-item-number"> 2 </span>
                    <div class="single-setup-request-list-item-contents">
                        <h5 class="single-setup-request-list-item-contents-title">{{ __('Upload gallery') }}</h5>
                        <p class="single-setup-request-list-item-contents-para">{{ __('Add some images to your shake') }}</p>
                    </div>
                </li>
                <li class="single-setup-request-list-item">
