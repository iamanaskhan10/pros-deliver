        ...
        <div class="create-project-intro-contents">
            <div class="create-project-intro-contents-form custom-form">
                ...
                <div class="single-input">
                    ...
                    <select name="subcategory[]" id="subcategory" class="form-control inf-custom-select get_subcategory subcategory_select2" multiple>
                    </select>
                    <span id="subcategory_info"></span>
                </div>


               <x-form.text :title="__('What are you offering to clients?')" :type="'text'" :id="'project_title'" :name="'project_title'" :divClass="'mb-0'" :class="'form--control'" :value="old('project_title')" :placeholder="__('You’ll create content, promote a product, or collaborate')" />
                ...
                <div class="single-input">
                    ...
                    <textarea name="meta_description" id="meta_description" class="form-message" cols="30" rows="3" placeholder="{{ __('Enter meta description') }}">{{ old('meta_description') ?? '' }}</textarea>
                </div>
