        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '.basic_price_setup', function () {
                ...
                if(basic_discount_charge != '' && basic_discount_charge > 0){
                    $('.basic_discount_charge').html(siteCurrency + basic_discount_charge);
                    $('.basic_regular_charge').html('<s>' + siteCurrency + basic_regular_charge + '</s>');
                }else{
                    $('.basic_discount_charge').html('');
                    $('.basic_regular_charge').html(siteCurrency + basic_regular_charge);
                }
            ...
            $(document).on('click', '.standard_price_setup', function () {
                ...
                if(standard_discount_charge != '' && standard_discount_charge > 0){
                    $('.standard_discount_charge').html(siteCurrency + standard_discount_charge);
                    $('.standard_regular_charge').html('<s>' + siteCurrency + standard_regular_charge + '</s>');
                }else{
                    $('.standard_discount_charge').html('');
                    $('.standard_regular_charge').html(siteCurrency + standard_regular_charge);
                }
             ...
             $(document).on('click', '.premium_price_setup', function () {
                ...
                if(premium_discount_charge != '' && premium_discount_charge > 0){
                    $('.premium_discount_charge').html(siteCurrency + premium_discount_charge);
                    $('.premium_regular_charge').html('<s>' + siteCurrency + premium_regular_charge + '</s>');
                }else{
                    $('.premium_discount_charge').html('');
                    $('.premium_regular_charge').html(siteCurrency + premium_regular_charge);
                }
            ...
            // Generic Open Modal (using data-type)
            $(document).on('click', '.click-edit-basic-price, .click-edit-standard-price, .click-edit-premium-price', function () {
                let type = $(this).data('type');
                let regular_charge = $('#'+type+'_regular_charge').val();
                let discount_charge = $('#'+type+'_discount_charge').val();

                $('#'+type+'_regular_charge_modal').val(regular_charge);
                $('#'+type+'_discount_charge_modal').val(discount_charge);

                $('.price-popup-'+type+'-charge').addClass('popup-active');
                $('.popup-overlay').addClass('popup-active');
            });

            // close modal
            $(document).on('click', '.popup-close, .popup-overlay', function () {
                $('.popup-fixed').removeClass('popup-active');
                $('.popup-overlay').removeClass('popup-active');
            });
