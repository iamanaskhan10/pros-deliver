    ...
    function pre_next()
    {
            ...
            if (current <= Listings.length) {
                ...
                if(current == 1){
                    ...
                    if(category == '' || subcategory == '' || title == '' || description == '' || level == '' || duration==''){
                        ...
                        $('.setup-footer-right').html('<button type="submit" class="btn-profile btn-bg-1" id="confirm_create_job">{{ __('Create Campaign') }}<span id="job_create_load_spinner"></span></button>');
                    }
                }
            }
        ...
        $(document).on("click", "#previous", function (){
            if (current > 0) {
                current--
                if(current == 2){
                    $('.setup-footer-right').html('<input type="submit" class="btn-profile btn-bg-1" value="{{ __('Create Campaign') }}">');
                }else{
