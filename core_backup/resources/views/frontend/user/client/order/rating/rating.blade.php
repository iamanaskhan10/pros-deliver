...
@section('content')
    <main>
        ...
        <div class="end-contract-area pat-100 pab-100 section-bg-2">
            <div class="container">
                <form action="{{ route('client.order.rating',$id) }}" method="post">
                    @csrf
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="end-contract">
                                ...
                                <div class="end-contract-feedback mt-4">
                                    ...
                                    <p class="end-contract-feedback-para mt-2">{{ __('Your feedback will be shared to publicly in freelancer profile and freelancer feedback will be shared publicly in your profile.') }}</p>
                                    <div class="end-contract-feedback-contents mt-4">
                                        ...
                                        <div data-reaction-type="skills" class="end-contract-feedback-single">
                                            <div class="end-contract-feedback-single-title-flex">
                                                <h4 class="end-contract-feedback-single-title">{{ __('How would you rate') }} {{ $find_login_user_order?->freelancer->first_name }}{{ __("'s") }}  {{ __('skills') }} </h4>
                                        ...
                                        <div data-reaction-type="availability" class="end-contract-feedback-single">
                                            <div class="end-contract-feedback-single-title-flex">
                                                <h4 class="end-contract-feedback-single-title">{{ __('Rate') }} {{ $find_login_user_order?->freelancer->first_name }}{{ __("'s") }} {{ __('availability') }} </h4>
                                                <div class="btn-wrapper click-skip">
                                        ...
                                        <div data-reaction-type="communication" class="end-contract-feedback-single">
                                            <div class="end-contract-feedback-single-title-flex">
                                                <h4 class="end-contract-feedback-single-title">{{ __('Rate') }} {{ $find_login_user_order?->freelancer->first_name }}{{ __("'s") }} {{ __('Communications') }} </h4>
                                                <div class="btn-wrapper click-skip">
                                        ...
                                        <div data-reaction-type="work-quality" class="end-contract-feedback-single">
                                            <div class="end-contract-feedback-single-title-flex">
                                                <h4 class="end-contract-feedback-single-title">{{ __('Rate') }} {{ $find_login_user_order?->freelancer->first_name }}{{ __("'s") }} {{ __('Work Quality') }} </h4>
                                                <div class="btn-wrapper click-skip">
                                        ...
                                        <div data-reaction-type="meeting-deadline" class="end-contract-feedback-single">
                                            <div class="end-contract-feedback-single-title-flex">
                                                <h4 class="end-contract-feedback-single-title">{{ __('Rate') }} {{ $find_login_user_order?->freelancer->first_name }}{{ __("'s") }} {{ __('Meetings') }} </h4>
                                                <div class="btn-wrapper click-skip">
                                        ...
                                        <div data-reaction-type="co-operations" class="end-contract-feedback-single">
                                            <div class="end-contract-feedback-single-title-flex">
                                                <h4 class="end-contract-feedback-single-title">{{ __('Rate') }} {{ $find_login_user_order?->freelancer->first_name }}{{ __("'s") }} {{ __('Co-operations') }} </h4>
                                                <div class="btn-wrapper click-skip">
...
@section('script')
    @include('frontend.user.client.order.rating.rating-js')
@endsection
