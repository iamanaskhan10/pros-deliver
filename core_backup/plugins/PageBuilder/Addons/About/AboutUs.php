...
class AboutUs extends PageBuilderBase
{
    ...
    public function frontend_render()
    {
        ...
        $repeater_data = $settings['creditility'] ?? '';


        return $this->renderBlade('about.about-us',compact(['title', 'description', 'image', 'padding_top','padding_bottom', 'section_bg','repeater_data']));
    }

    public function addon_title()
    {
        return __('About- about us');
    }
}
