...
class PageBuilderSetup
{
    private static function register_widgets(): array
    {
        ...
        $addons = [
            ...
            \plugins\PageBuilder\Addons\FeaturedInfluencer\FeaturedInfluencer::class,
            \plugins\PageBuilder\Addons\Job\LatestJob::class,
            \plugins\PageBuilder\Addons\HowMarketplaceWork\HowMarketplaceWork::class,
            \plugins\PageBuilder\Addons\CustomerSatisfaction\CustomerSatisfaction::class,
            \plugins\PageBuilder\Addons\Subscribe\Subscribe::class,
            ...
            \plugins\PageBuilder\Addons\About\AboutUsTwo::class,
            \plugins\PageBuilder\Addons\About\WhatWeDo::class,
            \plugins\PageBuilder\Addons\About\Credit::class,
            \plugins\PageBuilder\Addons\Shake\AllShakes::class,
            \plugins\PageBuilder\Addons\About\Team::class,
            \plugins\PageBuilder\Addons\About\MissionVision::class,
        ];
//        return $addons;
