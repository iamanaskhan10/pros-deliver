    ...
    <div class="navbar-right-item">
        <?php
            $unseen_message_count = \App\Models\User::select('id')
                ...
                ->first();
        ?>
        <a href="<?php echo e(route('client.live.chat')); ?>" class="navbar-right-chat position-relative reload_unseen_message_count">
            <i class="fa-regular fa-comment-dots"></i>
            <?php if($unseen_message_count->client_unseen_message_count > 0): ?>
                <span
                    class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger"><?php echo e($unseen_message_count->client_unseen_message_count ?? ''); ?></span>
            <?php endif; ?>
        </a>
    </div>
                ...
                <?php $__currentLoopData = $client_bookmarks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bookmark): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bookmark-item">
                        <?php if($bookmark->is_project_job === 'project'): ?>
                            <?php if(!empty($bookmark?->bookmark_project)): ?>
                                <a href="<?php echo e(route('shake.details', ['username' => $bookmark?->bookmark_project?->project_creator?->username, 'slug' => $bookmark?->bookmark_project?->slug])); ?>"
                            ...
                            <?php endif; ?>
                        <?php else: ?>
                            <?php if(!empty($bookmark?->bookmark_job)): ?>
                            ...
                            <?php endif; ?>
                        <?php endif; ?>
                        <span class="bookmark-item-close remove_from_bookmark" data-identity = "<?php echo e($bookmark->id); ?>"
        ...
        <div class="navbar-right-item">
            <?php
                $unseen_message_count = \App\Models\User::select('id')
                    ...
                    ->first();
            ?>
            <a href="<?php echo e(route('client.live.chat')); ?>"
        ...
        <div class="navbar-right-item">
            <?php
                $unseen_message_count = \App\Models\User::select('id')
                    ...
                    ->first();
            ?>
            <a href="<?php echo e(route('influencer.live.chat')); ?>"
                class="navbar-right-chat position-relative reload_unseen_message_count"> <i
                    class="fa-regular fa-comment-dots"></i>
                <?php if($unseen_message_count->freelancer_unseen_message_count > 0): ?>
                    <span
                        class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger"><?php echo e($unseen_message_count->freelancer_unseen_message_count ?? ''); ?></span>
                <?php endif; ?>
            </a>
        </div>
    <?php endif; ?>
            ...
            <?php if(!empty($freelancer_bookmarks) && $freelancer_bookmarks->count() > 0): ?>
                <?php $__currentLoopData = $freelancer_bookmarks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bookmark): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bookmark-item">
                        ...
                        <?php endif; ?>
                        <span class="bookmark-item-close remove_from_bookmark" data-identity = "<?php echo e($bookmark->id); ?>"
                            data-route = "<?php echo e(route('influencer.bookmark.remove')); ?>">
                            <i class="fas fa-times"></i>
                        </span>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
<?php /**PATH /home/prosdeliver/public_html/core/resources/views/components/frontend/menu-chat-bookmark.blade.php ENDPATH**/ ?>