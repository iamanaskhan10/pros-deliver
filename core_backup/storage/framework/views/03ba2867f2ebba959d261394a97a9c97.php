...
<script>
    (function($){
        ...
        $(document).on('click','.swal_phone_verify_button',function(e){
            e.preventDefault();
            Swal.fire({
                title: '<?php echo e(__("Are you sure?")); ?>',
                text: '<?php echo e(__("To verify this user phone.")); ?>',
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
...
<?php /**PATH /home/prosdeliver/public_html/core/resources/views/backend/layout/partials/footer.blade.php ENDPATH**/ ?>