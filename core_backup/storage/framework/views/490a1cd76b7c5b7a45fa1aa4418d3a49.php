...
<?php if($selectType === 'alternative'): ?>
    <select name="<?php echo e($name ?? ''); ?>" id="<?php echo e($id ?? ''); ?>" class="inf-custom-select <?php echo e($class ?? ''); ?>">
        ...
        <?php $__currentLoopData = $allCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($data->id); ?>" <?php echo e(old($name) == $data->id ? 'selected=selected' : ''); ?>>
...
<?php endif; ?>
<?php /**PATH /home/prosdeliver/public_html/core/resources/views/components/form/category-dropdown.blade.php ENDPATH**/ ?>