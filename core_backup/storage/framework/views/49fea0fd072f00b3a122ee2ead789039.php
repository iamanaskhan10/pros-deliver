                ...
                <form method="POST" action="<?php echo e(route('admin.login')); ?>">
                    ...
                    <div class="login-form-body">
                        ...
                        <div class="submit-btn-area">
                            <button id="form_submit" type="submit"><?php echo e(__('Login')); ?> <i
                                    class="fa-solid fa-arrow-right"></i></button>
                        </div>

                        
                        <?php if(url()->current() == 'https://influencer.bytesed.com/admin'): ?>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><button type="button" class="autoLogin"
                                                    id="autoLogin"><?php echo e(__('Login')); ?></button></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
...
<?php echo $__env->make('layouts.login-screens', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/prosdeliver/public_html/core/resources/views/backend/pages/auth/login.blade.php ENDPATH**/ ?>