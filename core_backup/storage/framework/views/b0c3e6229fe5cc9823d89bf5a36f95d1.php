    ...
    <div class="single-right-content">
        <div class="navbar-right-flex">
            <div class="navbar-right-item position-relative">
                <a href="#0" class="inf-cmn-btn style2 inf-black-btn-outline search-header-open">
            ...
            <div class="navbar-right-item position-relative">
                <a href="<?php echo e(route('user.login')); ?>" class="inf-cmn-btn style2 inf-black-btn-outline">
                    <?php echo e(__('Login')); ?>

                </a>
            </div>
            <div>
                <a href="<?php echo e(route('user.register')); ?>" class="inf-cmn-btn style2 inf-primary-btn">
...
<?php /**PATH /home/prosdeliver/public_html/core/resources/views/components/frontend/menu-search-login-register.blade.php ENDPATH**/ ?>