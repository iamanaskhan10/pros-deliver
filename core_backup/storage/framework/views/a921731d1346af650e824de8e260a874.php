<script>
    (function($){
        ...
        $(document).ready(function(){
            var notFoundHtml = <?php echo json_encode(view('components.frontend.not-found-dash')->render(), 15, 512) ?>;
            //update profile
            ...
            function histories(page){
                $.ajax({
                    url:"<?php echo e(route('influencer.wallet.paginate.data').'?page='); ?>" + page,
            ...
            $(document).on('keyup','#string_search',function(){
                ...
                $.ajax({
                    url:"<?php echo e(route('influencer.wallet.search')); ?>",
                    method:'GET',
...
<?php /**PATH /home/prosdeliver/public_html/core/Modules/Wallet/Resources/views/influencer/wallet/wallet-js.blade.php ENDPATH**/ ?>