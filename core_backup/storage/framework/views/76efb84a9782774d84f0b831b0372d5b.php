    ...
    <div class="dashboard__left__main">
        ...
        <div class="dashboard__bottom mt-5">
            <ul class="dashboard__bottom__list dashboard-list">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['user-list', 'user-trash-list', 'user-identity-verify-request-list', 'user-add', 'user-email-send-all'])): ?>
                <li
                    ...
                    <ul class="submenu">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('user-list')): ?>
                            <li class="dashboard__bottom__list__item <?php if(request()->routeIs(['admin.influencer.all'])): ?> selected <?php endif; ?>">
                                <a href="<?php echo e(route('admin.influencer.all')); ?>"> <?php echo e(__('All Influencers')); ?> </a>
                            </li>
                        ...
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('user-email-send-all')): ?>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('integration-view')): ?>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['plugin-list', 'plugin-add'])): ?>
                    <?php if(moduleExists('PluginManage')): ?>
                        <li
                            ...
                            <a href="javascript:void(0)"> <i class="fa-solid fa-plug"></i> <?php echo e(__('Plugin Manage')); ?> </a>
                            <ul class="submenu">
                                <li
                                    class="dashboard__bottom__list__item <?php if(request()->routeIs(['admin.plugin.manage.all'])): ?> selected <?php endif; ?>">
                                    <a href="<?php echo e(route('admin.plugin.manage.all')); ?>"> <?php echo e(__('All Plugins')); ?> </a>
                                </li>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('plugin-add')): ?>
                                    <li
                                        class="dashboard__bottom__list__item <?php if(request()->routeIs(['admin.plugin.manage.new'])): ?> selected <?php endif; ?>">
                ...
                <?php $__currentLoopData = $all_modules_route; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $externalMenu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php $__currentLoopData = $externalMenu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $individual_menu_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            ...
                            // Check permission
                            $permissions = $convert_to_array['permissions'] ?? [];
                            if (!empty($permissions) && !auth()->guard('admin')->user()->canany($permissions)) {
                                continue;
                            }
                        ?>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['category-list', 'subcategory-list'])): ?>
                <li
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('feedback-list')): ?>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('length-list')): ?>
                <li class="dashboard__bottom__list__item <?php if(request()->routeIs(['admin.length.all'])): ?> active <?php endif; ?>">
                    <a href="<?php echo e(route('admin.length.all')); ?>"> <i class="fa-regular fa-clock"></i><?php echo e(__('Campaign & Project Length')); ?></a>
                </li>
                <?php endif; ?>

                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('experience-level-list')): ?>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['project-list', 'project-history-list'])): ?>
                <li
                    ...
                    <ul class="submenu">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('project-history-list')): ?>
                            ...
                            <li class="dashboard__bottom__list__item <?php if(request()->routeIs(['admin.project.approval.settings'])): ?> selected <?php endif; ?>">
                                ...
                                <li class="dashboard__bottom__list__item <?php if(request()->routeIs(['admin.project.video.upload.settings'])): ?> selected <?php endif; ?>">
                                    <a href="<?php echo e(route('admin.project.video.upload.settings')); ?>"> <?php echo e(__('Project Video Upload Settings')); ?> </a>
                                </li>
                        <?php endif; ?>
                    </ul>
                </li>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['campaign-auto-approval', 'campaign-list', 'campaign-history-list'])): ?>
                <li
                    class="dashboard__bottom__list__item has-children <?php if(request()->is('admin/job*')): ?> active open show <?php endif; ?>">
                    <a href="javascript:void(0)"> <i class="fa-solid fa-file-word"></i><?php echo e(__('Campaigns')); ?> </a>
                    <ul class="submenu">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('campaign-auto-approval')): ?>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('campaign-list')): ?>
                            <li class="dashboard__bottom__list__item <?php if(request()->routeIs(['admin.jobs'])): ?> selected <?php endif; ?>">
                                <a href="<?php echo e(route('admin.jobs')); ?>"> <?php echo e(__('All Campaigns')); ?> </a>
                            </li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('campaign-history-list')): ?>
                            <li class="dashboard__bottom__list__item <?php if(request()->routeIs(['admin.job.history'])): ?> selected <?php endif; ?>">
                                <a href="<?php echo e(route('admin.job.history')); ?>"> <?php echo e(__('Campaign History')); ?> </a>
                            </li>
                        <?php endif; ?>
                    </ul>
                </li>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['portfolio-auto-approval', 'portfolio-list'])): ?>
                <li
                        class="dashboard__bottom__list__item has-children <?php if(request()->is('admin/portfolio*')): ?> active open show <?php endif; ?>">
                    <a href="javascript:void(0)"> <i class="fa-solid fa-file-word"></i><?php echo e(__('Portfolios')); ?> </a>
                    <ul class="submenu">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('portfolio-auto-approval')): ?>
                            <li class="dashboard__bottom__list__item <?php if(request()->routeIs(['admin.portfolio.approval.settings'])): ?> selected <?php endif; ?>">
                                <a href="<?php echo e(route('admin.portfolio.approval.settings')); ?>"> <?php echo e(__('Auto Approval Settings')); ?>

                                </a>
                            </li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('portfolio-list')): ?>
                            <li class="dashboard__bottom__list__item <?php if(request()->routeIs(['admin.portfolio.all'])): ?> selected <?php endif; ?>">
                                <a href="<?php echo e(route('admin.portfolio.all')); ?>"> <?php echo e(__('All Portfolio')); ?> </a>
                            </li>
                        <?php endif; ?>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['credit-settings-view', 'credit-list'])): ?>
                <li
                        class="dashboard__bottom__list__item has-children <?php if(request()->is('admin/credit*')): ?> active open show <?php endif; ?>">
                    <a href="javascript:void(0)"> <i class="fa-solid fa-coins"></i> <?php echo e(__('Credit')); ?></a>
                    <ul class="submenu">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('credit-settings-view')): ?>
                            <li class="dashboard__bottom__list__item <?php if(request()->routeIs(['admin.influencer.contact.info.settings'])): ?> selected <?php endif; ?>">
                                <a href="<?php echo e(route('admin.influencer.contact.info.settings')); ?>">
                                    <?php echo e(__('Influencer Contact Info Settings')); ?> </a>
                            </li>
                        <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('credit-list')): ?>
                                <li class="dashboard__bottom__list__item <?php if(request()->routeIs(['admin.credit.history'])): ?> selected <?php endif; ?>">
                                    <a href="<?php echo e(route('admin.credit.history')); ?>"> <?php echo e(__('Credit History')); ?> </a>
                                </li>
                            <?php endif; ?>
                    </ul>
                </li>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['deposit-settings-view', 'deposit-list'])): ?>
                <li
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['withdraw-settings-view', 'withdraw-payment-gateway-list', 'withdraw-list'])): ?>
                <li
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['subscription-type-list', 'subscription-list', 'subscription-connect-settings-view', 'user-subscription-list'])): ?>
                <li
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('user-report-list')): ?>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('chat-settings-view')): ?>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['login-page-settings-view', 'register-page-settings-view', 'account-page-settings-view', 'introduction-page-settings-view', 'experience-page-settings-view', 'work-page-settings-view', 'skill-page-settings-view', 'location-page-settings-view', 'photo-page-settings-view'])): ?>
                <li
                            ...
                            <ul class="submenu">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('account-page-settings-view')): ?>
                                    <li class="dashboard__bottom__list__item <?php if(request()->routeIs(['admin.page.account.main.page'])): ?> selected <?php endif; ?>">
                                        <a href="<?php echo e(route('admin.page.account.main.page')); ?>"><?php echo e(__('Account Page Settings')); ?> </a>
                                    </li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('introduction-page-settings-view')): ?>
                                    <li
                                        ...
                                        <a href="<?php echo e(route('admin.page.account.introduction')); ?>"><?php echo e(__('Introduction Settings')); ?> </a>
                                    </li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('experience-page-settings-view')): ?>
                                    <li class="dashboard__bottom__list__item <?php if(request()->routeIs(['admin.page.account.social'])): ?> selected <?php endif; ?>">
                                        <a href="<?php echo e(route('admin.page.account.social')); ?>"><?php echo e(__('Social Profile Settings')); ?> </a>
                                    </li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('work-page-settings-view')): ?>
                                    <li class="dashboard__bottom__list__item <?php if(request()->routeIs(['admin.page.account.work'])): ?> selected <?php endif; ?>">
                                        <a href="<?php echo e(route('admin.page.account.work')); ?>"> <?php echo e(__('Category Settings')); ?></a>
                                    </li>
                                <?php endif; ?>
                                ...
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('skill-page-settings-view')): ?>
                                    <li class="dashboard__bottom__list__item <?php if(request()->routeIs(['admin.page.account.language'])): ?> selected <?php endif; ?>">
                                        <a href="<?php echo e(route('admin.page.account.language')); ?>"> <?php echo e(__('Language Settings')); ?></a>
                                    </li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('location-page-settings-view')): ?>
                                    <li
                                        class="dashboard__bottom__list__item <?php if(request()->routeIs(['admin.page.account.location'])): ?> selected <?php endif; ?>">
                                        <a href="<?php echo e(route('admin.page.account.location')); ?>"><?php echo e(__('Location Settings')); ?> </a>
                                    </li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('photo-page-settings-view')): ?>
                                    <li
                                        ...
                                        <a href="<?php echo e(route('admin.page.account.rate.photo')); ?>"><?php echo e(__('Rate & Photo Settings')); ?> </a>
                                    </li>
                                <?php endif; ?>
                            </ul>
                        </li>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['reading', 'navbar-global-variant', 'footer-global-variant', 'site-identity', 'basic-settings', 'color-settings', 'typography-settings', 'seo-settings', 'third-party-script-settings', 'social-login-settings', 'email-template-settings', 'smtp-settings', 'custom-css-settings', 'custom-js-settings', 'gdpr-settings', 'cache-settings', 'database-upgrade', 'generate-license-key'])): ?>
                <li
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['payment-info-settings', 'payment-gateway-settings'])): ?>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['menu-list', 'form-list', 'widget-list'])): ?>
                    ...
                    <ul class="submenu">
                        ...
                        <li class="dashboard__bottom__list__item <?php if(request()->routeIs(['admin.job.enable.disable.settings'])): ?> selected <?php endif; ?>">
                            <a href="<?php echo e(route('admin.job.enable.disable.settings')); ?>">
                                <?php echo e(__('Campaign Enable Disable')); ?> </a>
                        </li>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['page-list', 'page-create-new', 'manage-404-page', 'manage-maintenance-page'])): ?>
                <li
...
<?php /**PATH /home/prosdeliver/public_html/core/resources/views/backend/layout/partials/left-sidebar.blade.php ENDPATH**/ ?>