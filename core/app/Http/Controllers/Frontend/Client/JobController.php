    ...
    public function job_create(Request $request)
    {
        if ($request->isMethod('post')) {
            $request->validate([
                ...
                'min_followers' => 'nullable|numeric|gt:0',
            ...
            try {
                ...
                $message = str_replace(["@campaign_id"], [$job->id], $message);
            ...
            AdminNotification::create([
                ...
                'user_id' => $user_id,
                'type' => 'Job',
                'message' => __('New campaign has been published.'),
            ]);

            toastr_success(__('Campaign successfully created'));
    ...
    public function job_edit(Request $request, $id)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            AdminNotification::create([
                ...
                'user_id' => $user_id,
                'type' => 'Edit Job',
                'message' => __('A campaign has been edited'),
            ]);

            toastr_success(__('Campaign successfully Updated'));
            return redirect()->route('client.job.all');
        }
