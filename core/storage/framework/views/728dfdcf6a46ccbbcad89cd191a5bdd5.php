            ...
            <?php if(Auth::guard('web')->check()): ?>
                <?php if(Auth::guard('web')->user()->user_type == 2): ?>
                    <?php if(Session::get('user_role') == 'client'): ?>
                        <?php echo $__env->make('frontend.user.layout.partials.act-as-client-sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    <?php else: ?>
                        <ul class="profile-settings-menu-list">
                            <li class="profile-settings-menu-item <?php if(request()->routeIs('influencer.dashboard')): ?> active <?php endif; ?>">
                                <a href="<?php echo e(route('influencer.dashboard')); ?>" class="profile-settings-menu-item-link">
                            ...
                            <?php if(get_static_option('project_enable_disable') != 'disable'): ?>
                                <?php if(moduleExists('SecurityManage')): ?>
                                    <?php if(Auth::guard('web')->user()->freeze_project == 'freeze'): ?>
                                        <li
                                            class="profile-settings-menu-item <?php if(Auth::guard('web')->user()->freeze_project == 'freeze'): ?> disabled-link <?php endif; ?>">
                                    ...
                                    <?php else: ?>
                                        <li class="profile-settings-menu-item">
                                            <a href="<?php echo e(route('influencer.project.create')); ?>"
                                                class="profile-settings-menu-item-link">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                            ...
                            <?php endif; ?>
                            <li class="profile-settings-menu-item">
                                <a href="<?php echo e(route('influencer.order.all')); ?>" class="profile-settings-menu-item-link">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <li class="profile-settings-menu-item">
                                <a href="<?php echo e(route('influencer.offers')); ?>" class="profile-settings-menu-item-link">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <li class="profile-settings-menu-item">
                                <a href="<?php echo e(route('influencer.proposal')); ?>" class="profile-settings-menu-item-link">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <li class="profile-settings-menu-item <?php if(request()->routeIs('influencer.ticket')): ?> active <?php endif; ?>">
                                <a href="<?php echo e(route('influencer.ticket')); ?>" class="profile-settings-menu-item-link">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li class="profile-settings-menu-item <?php if(request()->routeIs('influencer.wallet.history')): ?> active <?php endif; ?>">
                                <a href="<?php echo e(route('influencer.wallet.history')); ?>"
                                    class="profile-settings-menu-item-link">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <li class="profile-settings-menu-item <?php if(request()->routeIs('influencer.wallet.withdraw.history')): ?> active <?php endif; ?>">
                                <a href="<?php echo e(route('influencer.wallet.withdraw.history')); ?>"
                                    class="profile-settings-menu-item-link">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <mask id="mask0_6523_7035" style="mask-type:alpha" maskUnits="userSpaceOnUse"
                                            x="0" y="0" width="24" height="24">
                                            <rect width="24" height="24" fill="#D9D9D9" />
                                        </mask>
                            ...
                            <?php if(get_static_option('subscription_enable_disable') != 'disable'): ?>
                                <li
                                    class="profile-settings-menu-item <?php if(request()->routeIs('influencer.subscriptions.all')): ?> active <?php endif; ?>">
                                    <a href="<?php echo e(route('influencer.subscriptions.all')); ?>"
                                        class="profile-settings-menu-item-link">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                            ...
                            <?php endif; ?>
                            <li class="profile-settings-menu-item <?php if(request()->routeIs('influencer.live.chat')): ?> active <?php endif; ?>">
                            ...
                            <li class="profile-settings-menu-item <?php if(request()->routeIs('influencer.profile')): ?> active <?php endif; ?>">
                                <a href="<?php echo e(route('influencer.profile')); ?>" class="profile-settings-menu-item-link">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <li class="profile-settings-menu-item">
                                <a href="<?php echo e(route('influencer.account.setup')); ?>"
                                    class="profile-settings-menu-item-link">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <li class="profile-settings-menu-item <?php if(request()->routeIs('influencer.identity.verification')): ?> active <?php endif; ?>">
                                <a href="<?php echo e(route('influencer.identity.verification')); ?>"
                                    class="profile-settings-menu-item-link">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <li class="profile-settings-menu-item <?php if(request()->routeIs('influencer._2fa')): ?> active <?php endif; ?>">
                                <a href="<?php echo e(route('influencer._2fa')); ?>" class="profile-settings-menu-item-link">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <li class="profile-settings-menu-item">
                                <a href="<?php echo e(route('influencer.password')); ?>" class="profile-settings-menu-item-link">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <li class="profile-settings-menu-item">
                                <a href="<?php echo e(route('influencer.account.delete')); ?>"
                                    class="profile-settings-menu-item-link">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <li class="profile-settings-menu-item">
                                <a href="<?php echo e(route('influencer.logout')); ?>" class="profile-settings-menu-item-link">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M15.24 22.2705H15.11C10.67 22.2705 8.53002 20.5205 8.16002 16.6005C8.12002 16.1905 8.42002 15.8205 8.84002 15.7805C9.24002 15.7405 9.62002 16.0505 9.66002 16.4605C9.95002 19.6005 11.43 20.7705 15.12 20.7705H15.25C19.32 20.7705 20.76 19.3305 20.76 15.2605V8.74047C20.76 4.67047 19.32 3.23047 15.25 3.23047H15.12C11.41 3.23047 9.93002 4.42047 9.66002 7.62047C9.61002 8.03047 9.26002 8.34047 8.84002 8.30047C8.42002 8.27047 8.12001 7.90047 8.15001 7.49047C8.49001 3.51047 10.64 1.73047 15.11 1.73047H15.24C20.15 1.73047 22.25 3.83047 22.25 8.74047V15.2605C22.25 20.1705 20.15 22.2705 15.24 22.2705Z"
                ...
                <?php else: ?>
                    <?php if(Session::get('user_role') == 'freelancer'): ?>
                        <?php echo $__env->make('frontend.user.layout.partials.act-as-freelancer-sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    <?php else: ?>
                        <ul class="profile-settings-menu-list">
                            ...
                            <?php if(moduleExists('SecurityManage')): ?>
                                <?php if(Auth::guard('web')->user()->freeze_job == 'freeze'): ?>
                                    <li
                                        class="profile-settings-menu-item <?php if(Auth::guard('web')->user()->freeze_job == 'freeze'): ?> disabled-link <?php endif; ?>">
                                        <a href="#" class="profile-settings-menu-item-link">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                            ...
                            <li class="profile-settings-menu-item <?php if(request()->routeIs('client.wallet.history')): ?> active <?php endif; ?>">
                                <a href="<?php echo e(route('client.wallet.history')); ?>"
                                    class="profile-settings-menu-item-link">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <?php if(moduleExists('Credit')): ?>
                                <li class="profile-settings-menu-item <?php if(request()->routeIs('client.credit.history')): ?> active <?php endif; ?>">
                                    <a href="<?php echo e(route('client.credit.history')); ?>" class="profile-settings-menu-item-link">
...
<?php /**PATH /home/prosdeliver/public_html/core/resources/views/frontend/user/layout/partials/sidebar.blade.php ENDPATH**/ ?>