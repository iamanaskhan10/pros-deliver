    ...
    function pre_next()
    {
            ...
            if (current <= Listings.length) {
                ...
                if(current == 1){
                    ...
                    if(category == '' || subcategory == '' || title == '' || description == '' || level == '' || duration==''){
                        ...
                        $('.setup-footer-right').html('<button type="submit" class="btn-profile btn-bg-1" id="confirm_create_job"><?php echo e(__('Create Campaign')); ?><span id="job_create_load_spinner"></span></button>');
                    }
                }
            }
        ...
        $(document).on("click", "#previous", function (){
            if (current > 0) {
                current--
                if(current == 2){
                    $('.setup-footer-right').html('<input type="submit" class="btn-profile btn-bg-1" value="<?php echo e(__('Create Campaign')); ?>">');
                }else{
...
<?php /**PATH /home/prosdeliver/public_html/core/resources/views/frontend/user/client/job/create/create-job-js.blade.php ENDPATH**/ ?>