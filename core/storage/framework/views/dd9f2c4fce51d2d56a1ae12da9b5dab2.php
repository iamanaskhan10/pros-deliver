<?php $__env->startSection('title', __('All Clients')); ?>
                ...
                <div class="customMarkup__single">
                    <div class="customMarkup__single__item">
                        <div class="customMarkup__single__item__flex">
                            <h4 class="customMarkup__single__title"><?php echo e(__('All Clients')); ?></h4>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.search.search-in-table','data' => ['id' => 'string_search']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.notice.general-notice','data' => ['class' => 'mb-5','description' => __('Notice: Suspended user will complete his active and delivered order.'),'description1' => __('Notice: Suspended user can withdraw his balance.'),'description2' => __('Notice: A suspended user will be unable to place new order.'),'description3' => __('Notice: When an admin deactivates a user account, the user will no longer receive new orders. Additionally, projects and jobs associated with both freelancers and clients will be hidden from public view until the account is reactivated.'),'description4' => __('Notice: Identity verify means user verified his identity by legal documents')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('mb-5'),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Notice: Suspended user will complete his active and delivered order.')),'description1' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Notice: Suspended user can withdraw his balance.')),'description2' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Notice: A suspended user will be unable to place new order.')),'description3' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Notice: When an admin deactivates a user account, the user will no longer receive new orders. Additionally, projects and jobs associated with both freelancers and clients will be hidden from public view until the account is reactivated.')),'description4' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Notice: Identity verify means user verified his identity by legal documents'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                            <?php if(moduleExists('SecurityManage')): ?>
                                <?php if (isset($component)) { $__componentOriginalfc4e3c8108f5f9458dc90e11adc2a670 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalfc4e3c8108f5f9458dc90e11adc2a670 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.notice.general-notice','data' => ['class' => 'mb-5','description' => __('Notice: A freeze on jobs create edit means that clients are unable to create and edit his job.'),'description1' => __('Notice: A freeze on chat means that clients are unable to send chat message.'),'description2' => __('Notice: A freeze on order means that clients are unable to create new orders.')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('notice.general-notice'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('mb-5'),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Notice: A freeze on jobs create edit means that clients are unable to create and edit his job.')),'description1' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Notice: A freeze on chat means that clients are unable to send chat message.')),'description2' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Notice: A freeze on order means that clients are unable to create new orders.'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalfc4e3c8108f5f9458dc90e11adc2a670)): ?>
<?php $attributes = $__attributesOriginalfc4e3c8108f5f9458dc90e11adc2a670; ?>
...
<?php endif; ?>
                            ...
                            <div class="custom_table mt-3 style-04 search_result">
                                <?php echo $__env->make('backend.pages.user.clients.search-result', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            </div>
                            <!-- Table End -->
                        </div>
                    </div>
    ...
    <?php echo $__env->make('backend.pages.user.clients.user-details-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('backend.pages.user.clients.user-password-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('backend.pages.user.clients.user-details-edit-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php echo $__env->make('backend.pages.user.clients.identity-verify-details-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.bulk-action.bulk-delete-js','data' => ['url' => route('admin.user.delete.bulk.action')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
    <?php echo $__env->make('backend.pages.user.clients.user-js', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('backend.layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/prosdeliver/public_html/core/resources/views/backend/pages/user/clients/all-clients.blade.php ENDPATH**/ ?>