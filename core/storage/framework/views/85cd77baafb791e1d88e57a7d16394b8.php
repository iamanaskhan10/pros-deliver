<?php $__env->startSection('title', __('Maintenance Page Manage')); ?>
            ...
            <div class="col-lg-12">
                <div class="customMarkup__single">
                    <div class="customMarkup__single__item">
                        <h4 class="customMarkup__single__title"><?php echo e(__('Maintenance Page Manage')); ?></h4>
...
<?php endif; ?>
                        <div class="customMarkup__single__inner mt-4">
                            <form action="<?php echo e(route('admin.page.maintenance')); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <div class="single-input mb-3">
                                    <label for="maintain_page_title" class="label-title"><?php echo e(__('Title')); ?></label>
                                    <input type="text" name="maintain_page_title"  class="form-control"  value="<?php echo e(get_static_option('maintain_page_title')); ?>">
                                </div>
                                <div class="single-input mb-3">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.image','data' => ['title' => __('Maintenance Image'),'name' => 'maintain_page_logo','dimentions' => '540x345']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Maintenance Image')),'name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('maintain_page_logo'),'dimentions' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('540x345')]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update-maintenance-page')): ?>
...
<?php echo $__env->make('backend.layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/prosdeliver/public_html/core/Modules/Pages/Resources/views/maintenance-page.blade.php ENDPATH**/ ?>