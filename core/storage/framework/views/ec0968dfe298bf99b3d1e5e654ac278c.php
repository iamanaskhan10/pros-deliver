...
<script src="<?php echo e(asset('assets/backend/js/dropzone/dropzone.js')); ?>"></script>
<script>
    (function ($) {
        "use strict";
        var mainUploadBtn = '';
        ...
        $(document).on('click','.media_upload_modal_submit_btn',function (e) {
            ...
            if( typeof allData != 'undefined'){
                ...
                $.each(allData,function(index,value){
                    ...
                    var mediaContent;
                    if (el.imgsrc.endsWith('.mp4')) {
                        mediaContent = '<video controls src="' + el.imgsrc + '"></video>';
                    } else {
                        mediaContent = '<img src="' + el.imgsrc + '">';
                    }

                    mainUploadBtn.parent().find('.img-wrap').append('<div class="img-inner-wrap"><div class="rmv-span"><i class="<?php echo e($trash_icon); ?>"></i></div><div class="attachment-preview"><div class="thumbnail"><div class="centered">'+mediaContent+'</div></div></div></div>');
                });
        ...
        $('body').on('click', '.media-uploader-image-list > li', function (e) {
            ...
            var el = $(this);
            var allData = el.data();
            var mediaUrl = allData.imgsrc;
            var mediaContainer = $('.media-uploader-image-info .img-wrapper');
...
<?php /**PATH /home/prosdeliver/public_html/core/resources/views/components/media/js.blade.php ENDPATH**/ ?>