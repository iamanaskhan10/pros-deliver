    ...
    (function($){
        ...
        $(document).ready(function(){
            ...
            $(document).on('click', '.job_open_close', function(e) {
                ...
                if(job_on_off == 0){
                    title = "<?php echo e(__('Are you sure to open this campaign?')); ?>";
                    text = "<?php echo e(__('If you open this campaign it will publicly visible and freelancer will send campaign proposal')); ?>";
                    confirmation = "<?php echo e(__('Yes, open it!')); ?>";
                }else{
                    title = "<?php echo e(__('Are you sure to close this campaign?')); ?>";
                    text = "<?php echo e(__('If you close this campaign it will not publicly visible and freelancer will not send campaign proposal')); ?>";
                        ...
                        $.ajax({
                            ...
                            success:function(res){
                                if(res.status == 1){
                                    ...
                                    toastr_success_js("<?php echo e(__('Campaign successfully open')); ?>");
                                }else{
                                    $('.job_open_close_location_'+ job_id).load(mainPageUrl.href + ' .job_open_close_location_' + job_id)
                                    toastr_success_js("<?php echo e(__('Campaign successfully closed')); ?>")
                                }
                            }
                        })
                    }
...
<?php /**PATH /home/prosdeliver/public_html/core/resources/views/frontend/user/client/job/my-job/all-jobs-js.blade.php ENDPATH**/ ?>