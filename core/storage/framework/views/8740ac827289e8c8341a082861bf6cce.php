    ...
    (function($){
        ...
        $(document).ready(function(){
            ...
            $(document).on('click','.add_skill',function(e){
                ...
                let skill = $('#skill').val();
                if(skill == '' || category == ''){
                    toastr_warning_js("<?php echo e(__('Please fill both skill & category field !')); ?>");
                    return false;
                }
            });
            ...
            function projects(page){
                $.ajax({
                    url:"<?php echo e(route('admin.project.paginate.data').'?page='); ?>" + page,
            ...
            $(document).on('keyup input','#string_search',function(){
                ...
                $.ajax({
                    url:"<?php echo e(route('admin.project.search')); ?>",
                    method:'GET',
...
<?php /**PATH /home/prosdeliver/public_html/core/resources/views/backend/pages/project/project-js.blade.php ENDPATH**/ ?>