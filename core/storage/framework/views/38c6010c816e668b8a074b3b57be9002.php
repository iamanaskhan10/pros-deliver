<?php $__env->startSection('title', __('All Projects')); ?>
                ...
                <div class="customMarkup__single">
                    <div class="customMarkup__single__item">
                        <div class="customMarkup__single__item__flex">
                            <h4 class="customMarkup__single__title"><?php echo e(__('All Projects')); ?></h4>
...
<?php endif; ?>
                        ...
                        <div class="customMarkup__single__inner mt-4">
                            ...
                            <div class="custom_table style-04 search_result">
                                <?php echo $__env->make('backend.pages.project.search-result', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            </div>
                            <!-- Table End -->
                        </div>
                    </div>
...
<?php endif; ?>
    <?php echo $__env->make('backend.pages.project.project-js', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('backend.layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/prosdeliver/public_html/core/resources/views/backend/pages/project/all-project.blade.php ENDPATH**/ ?>