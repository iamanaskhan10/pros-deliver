...
<?php $__env->startSection('content'); ?>
    ...
    <?php if($page_post->page_builder_status === 'on'): ?>
        ...
        <?php if(!auth()->guard('web')->check() && $page_post->visibility === 'all'): ?>
            <?php echo $__env->make('frontend.pages.dynamic.partials.dynamic-page-builder-part',['page_post' => $page_post], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <?php endif; ?>
    <?php else: ?>
        <?php echo $__env->make('frontend.pages.dynamic.partials.dynamic-content', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php endif; ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('frontend.layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/prosdeliver/public_html/core/resources/views/frontend/pages/dynamic/dynamic-single.blade.php ENDPATH**/ ?>