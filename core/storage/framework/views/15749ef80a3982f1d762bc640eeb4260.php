...
<?php if (! $__env->hasRenderedOnce('1173e280-ca6a-435a-bcdd-a39245660248')): $__env->markAsRenderedOnce('1173e280-ca6a-435a-bcdd-a39245660248'); ?>
<style>
/* ═══════════════════════════════════════════════════════════════════════
   ANIMATIONS
   ═══════════════════════════════════════════════════════════════════════ */
...
(function() {
    ...
    window.AITranslator = {
        ...
        endpoint  : '<?php echo e(route("ai.translate.request")); ?>',
    ...
    document.addEventListener('click', function(e) {
        ...
        if (state === 'translated') {
            ...
            icon.textContent  = '🌐';
            label.textContent = '<?php echo e(__("Translate")); ?>';
        ...
        if (btn.dataset.translated) {
            ...
            icon.textContent  = '📄';
            label.textContent = '<?php echo e(__("Show Original")); ?>';
        ...
        AITranslator.translate(
            ...
            function() {
                ...
                label.textContent     = '<?php echo e(__("Translating...")); ?>';
            },
            function(res) {
    ...
    function _addJobBadge(wrap, lang) {
        ...
        b.innerHTML = '🔍 <?php echo e(__("Detected")); ?>: <strong>' + lang.toUpperCase() + '</strong>';
        row.appendChild(b);
    }
    ...
    document.addEventListener('click', function(e) {
        ...
        if (state === 'translated') {
            ...
            labelEl.textContent  = '<?php echo e(__("Translate")); ?>';
        ...
        if (btn.dataset.txCached) {
            ...
            labelEl.textContent  = '<?php echo e(__("Show Original")); ?>';
            return;
        }
        ...
        AITranslator.translate(
            ...
            function() {
                ...
                labelEl.textContent   = '<?php echo e(__("Translating...")); ?>';
            },
            function(res) {
                btn.disabled          = false;
                spinner.style.display = 'none';
    ...
    document.addEventListener('click', function(e) {
        ...
        if (state === 'translated') {
            ...
            btn.dataset.state    = 'original';
            icon.textContent     = '🌐';
            btnLabel.textContent = '<?php echo e(__("Translate to English")); ?>';
            return;
        }
        ...
        if (btn.dataset.translated) {
            ...
            btn.dataset.state    = 'translated';
            icon.textContent     = '📄';
            btnLabel.textContent = '<?php echo e(__("Show Original")); ?>';
            return;
        }
        ...
        AITranslator.translate(
            ...
            function() {
                ...
                spinner.style.display = 'inline-block';
                icon.style.display    = 'none';
                btnLabel.textContent  = '<?php echo e(__("Translating...")); ?>';
            },
            function(res) {
                btn.disabled          = false;
                spinner.style.display = 'none';
                ...
                if (txLabel) {
                    txLabel.innerHTML = '🌐 <?php echo e(__("Translated to English")); ?>' + (res.detected_lang ? ' &middot; <?php echo e(__("from")); ?> <strong>' + res.detected_lang.toUpperCase() + '</strong>' : '');
...
<?php endif; ?>
<?php /**PATH /home/prosdeliver/public_html/core/resources/views/components/ai-translate-toggle.blade.php ENDPATH**/ ?>