...
<div class="single-input mb-3 <?php echo e($class); ?>">
    ...
    <div class="media-upload-btn-wrapper">
        <div class="img-wrap">
            ...
            <?php if(!empty($signature_img)): ?>
                <div class="rmv-span"><i class="fas fa-times"></i></div>
    ...
    <?php if(!empty($dimentions)): ?> <small><?php echo e(__('recommended image size is')); ?> <?php echo e($dimentions ?? ''); ?></small> <?php endif; ?>
</div>
<?php /**PATH /home/prosdeliver/public_html/core/resources/views/components/backend/image.blade.php ENDPATH**/ ?>