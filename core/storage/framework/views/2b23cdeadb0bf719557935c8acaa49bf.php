        ...
        <ul class="single-setup-request-list list-style-none">
            <li class="single-setup-request-list-item running">
                ...
                <div class="single-setup-request-list-item-contents">
                    <h5 class="single-setup-request-list-item-contents-title"><?php echo e(__('About Campaign')); ?> </h5>
                </div>
            </li>
            <li class="single-setup-request-list-item">
                <span class="single-setup-request-list-item-number"> 2 </span>
                <div class="single-setup-request-list-item-contents">
                    <h5 class="single-setup-request-list-item-contents-title"> <?php echo e(__('Budget, Skills')); ?> </h5>
                </div>
            </li>
        </ul>
    </div>
</div>
<?php /**PATH /home/prosdeliver/public_html/core/resources/views/frontend/user/client/job/create/job-header.blade.php ENDPATH**/ ?>