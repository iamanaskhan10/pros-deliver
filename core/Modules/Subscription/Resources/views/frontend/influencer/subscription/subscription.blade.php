                                    ...
                                    <div class="single-profile-settings-contents">
                                        <div class="single-profile-settings-contents-upload">
                                            ...
                                            @if(get_static_option('stripe_subscription_enabled') == 'on')
                                                <div class="single-profile-settings-contents-upload-btn">
                                                    <a href="{{ route('influencer.subscriptions.billing.portal') }}" class="btn-profile btn-bg-1">{{ __('Manage Stripe Billing') }}</a>
                                                </div>
                                            @endif
                                        </div>
                                    </div>
                            ...
                            <div class="single-profile-settings border-all" id="display_client_profile_info">
                                ...
                                <div class="single-profile-settings-inner profile-border-top">
                                    <div class="custom_table style-04 search_result">
                                          @include('subscription::frontend.influencer.subscription.search-result')
                                    </div>
                                </div>
                            </div>
                        </div>
...
@section('script')
    @include('subscription::frontend.influencer.subscription.subscription-js')
@endsection
