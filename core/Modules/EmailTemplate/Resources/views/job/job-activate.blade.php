...
@section('title', __('Campaign Activate Email'))
@section('style')
                ...
                <div class="customMarkup__single">
                    <div class="customMarkup__single__item">
                        <div class="customMarkup__single__item__flex">
                            <h4 class="customMarkup__single__title">{{ __('Campaign Activate Email') }}</h4>
                        </div>
                        ...
                        <div class="customMarkup__single__inner mt-4">
                            ...
                            <form action="{{route('admin.user.job.activate')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <x-form.text
                                    ...
                                    :value="get_static_option('job_approve_email_subject') ?? __('Campaign Approve Email')"
                                />
                                <x-form.summernote
