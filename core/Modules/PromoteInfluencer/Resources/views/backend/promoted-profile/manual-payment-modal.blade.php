...
<div class="modal fade" id="editPaymentGatewayModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{route('admin.profile.promote.payment.status')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="promoted_profile_list_id" id="promoted_profile_list_id">
                <input type="hidden" name="promoted_profile_user_id" id="promoted_profile_user_id">
