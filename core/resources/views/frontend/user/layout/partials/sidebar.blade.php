                ...
                @if (Auth::guard('web')->user()->user_type == 2)
                    ...
                    @else
                        <ul class="profile-settings-menu-list">
                            <li class="profile-settings-menu-item @if (request()->routeIs('influencer.dashboard')) active @endif">
                                <a href="{{ route('influencer.dashboard') }}" class="profile-settings-menu-item-link">
                            ...
                            @if (moduleExists('PromoteInfluencer'))
                                <li class="profile-settings-menu-item @if (request()->routeIs('influencer.promoted.list')) active @endif">
                                    <a href="{{ route('influencer.promoted.list') }}"
                            ...
                            @if (get_static_option('project_enable_disable') != 'disable')
                                @if (moduleExists('SecurityManage'))
                                    @if (Auth::guard('web')->user()->freeze_project == 'freeze')
                                        <li
                                            class="profile-settings-menu-item @if (Auth::guard('web')->user()->freeze_project == 'freeze') disabled-link @endif">
                            ...
                            @endif
                            <li class="profile-settings-menu-item">
                                <a href="{{ route('influencer.order.all') }}" class="profile-settings-menu-item-link">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <li class="profile-settings-menu-item">
                                <a href="{{ route('influencer.offers') }}" class="profile-settings-menu-item-link">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <li class="profile-settings-menu-item">
                                <a href="{{ route('influencer.proposal') }}" class="profile-settings-menu-item-link">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <li class="profile-settings-menu-item @if (request()->routeIs('influencer.ticket')) active @endif">
                                <a href="{{ route('influencer.ticket') }}" class="profile-settings-menu-item-link">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li class="profile-settings-menu-item @if (request()->routeIs('influencer.wallet.history')) active @endif">
                            ...
                            <li class="profile-settings-menu-item @if (request()->routeIs('influencer.wallet.withdraw.history')) active @endif">
                            ...
                            @if (get_static_option('subscription_enable_disable') != 'disable')
                                <li
                                    class="profile-settings-menu-item @if (request()->routeIs('influencer.subscriptions.all')) active @endif">
                                    <a href="{{ route('influencer.subscriptions.all') }}"
                                        class="profile-settings-menu-item-link">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                            ...
                            @endif
                            <li class="profile-settings-menu-item @if (request()->routeIs('influencer.live.chat')) active @endif">
                            ...
                            <li class="profile-settings-menu-item @if (request()->routeIs('influencer.profile')) active @endif">
                                <a href="{{ route('influencer.profile') }}" class="profile-settings-menu-item-link">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <li class="profile-settings-menu-item @if (request()->routeIs('influencer.identity.verification')) active @endif">
                                <a href="{{ route('influencer.identity.verification') }}"
                                    class="profile-settings-menu-item-link">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <li class="profile-settings-menu-item @if (request()->routeIs('influencer._2fa')) active @endif">
                                <a href="{{ route('influencer._2fa') }}" class="profile-settings-menu-item-link">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <li class="profile-settings-menu-item">
                                <a href="{{ route('influencer.password') }}" class="profile-settings-menu-item-link">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <li class="profile-settings-menu-item">
                                <a href="{{ route('influencer.account.delete') }}"
                                    class="profile-settings-menu-item-link">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <li class="profile-settings-menu-item">
                                <a href="{{ route('influencer.logout') }}" class="profile-settings-menu-item-link">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M15.24 22.2705H15.11C10.67 22.2705 8.53002 20.5205 8.16002 16.6005C8.12002 16.1905 8.42002 15.8205 8.84002 15.7805C9.24002 15.7405 9.62002 16.0505 9.66002 16.4605C9.95002 19.6005 11.43 20.7705 15.12 20.7705H15.25C19.32 20.7705 20.76 19.3305 20.76 15.2605V8.74047C20.76 4.67047 19.32 3.23047 15.25 3.23047H15.12C11.41 3.23047 9.93002 4.42047 9.66002 7.62047C9.61002 8.03047 9.26002 8.34047 8.84002 8.30047C8.42002 8.27047 8.12001 7.90047 8.15001 7.49047C8.49001 3.51047 10.64 1.73047 15.11 1.73047H15.24C20.15 1.73047 22.25 3.83047 22.25 8.74047V15.2605C22.25 20.1705 20.15 22.2705 15.24 22.2705Z"
                        ...
                        <ul class="profile-settings-menu-list">
                            ...
                            @if (moduleExists('SecurityManage'))
                                @if (Auth::guard('web')->user()->freeze_job == 'freeze')
                                    <li
                                        class="profile-settings-menu-item @if (Auth::guard('web')->user()->freeze_job == 'freeze') disabled-link @endif">
                                        <a href="#" class="profile-settings-menu-item-link">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                            ...
                            @if(moduleExists('Credit'))
                                <li class="profile-settings-menu-item @if (request()->routeIs('client.credit.history')) active @endif">
                                    <a href="{{ route('client.credit.history') }}" class="profile-settings-menu-item-link">
