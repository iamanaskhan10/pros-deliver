                                ...
                                <div class="profile-border-top">
                                    <ul class="jobFilter-wrapper-item-bottom-list">
                                        ...
                                        <li class="jobFilter-wrapper-item-bottom-list-item">
                                            ...
                                            @else
                                                <span class="item-para">{{ __('Campaign created') }} <strong>{{ $job_details->created_at->toFormattedDateString() }}</strong></span>
                                           @endif
                                         </li>
                                    </ul>
                                </div>
                                        ...
                                        @if(moduleExists('SecurityManage'))
                                            @if(Auth::guard('web')->user()->freeze_job == 'freeze')
                                                <a href="#" class="btn-profile btn-og-1 @if(Auth::guard('web')->user()->freeze_job == 'freeze') disabled-link @endif">
                                                    <i class="fa-sharp fa-regular fa-pen-to-square"></i>{{ __('Edit Campaign') }}
                                                </a>
                                            @else
                                                <a href="{{ route('client.job.edit',$job_details->id) }}" class="btn-profile btn-bg-1"> <i class="fa-sharp fa-regular fa-pen-to-square"></i>{{ __('Edit Campaign') }}</a>
                                            @endif
                                        @else
                                            <a href="{{ route('client.job.edit',$job_details->id) }}" class="btn-profile btn-bg-1"> <i class="fa-sharp fa-regular fa-pen-to-square"></i>{{ __('Edit Campaign') }}</a>
                                        @endif
