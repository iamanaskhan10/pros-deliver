            ...
            <div class="setup-wrapper-finish-profile">
                <div class="setup-wrapper-finish-profile-flex">
                    <div class="setup-wrapper-finish-profile-thumb profile_photo_area">
                        ...
                        @else
                            <img src="{{ asset('assets/static/img/author/author.jpg') }}" alt="{{ __('profileImg') }}">
                        @endif
                    </div>
                    <div class="setup-wrapper-finish-profile-content">
                        ...
                        <p class="setup-wrapper-finish-profile-content-para"> {{ __('Profile photo should be minimum 300x300 pixels') }} </p>
                    </div>
                </div>
            </div>
        </div>
