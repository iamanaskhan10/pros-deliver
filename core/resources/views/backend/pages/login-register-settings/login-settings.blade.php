                    ...
                    <div class="customMarkup__single__item">
                        ...
                        <div class="customMarkup__single__inner mt-4">
                            <form action="{{route('admin.page.settings.login')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <br>
                                <x-form.textarea :title="__('Sidebar Description')" :name="'login_page_sidebar_description'" :value="get_static_option('login_page_sidebar_description') ?? '' " :placeholder="__('Once login you will see the magic of influencer marketplace.')"/>
                                <br>
                                <div class="switch">
