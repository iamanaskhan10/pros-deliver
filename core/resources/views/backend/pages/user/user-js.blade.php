    ...
    (function($){
        ...
        $(document).ready(function(){
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        if (res.status == 'success') {
                            ...
                            $(".state_info").html(all_state.length ? '' : '<span class="text-danger">{{ __("No state found for selected country!") }}</span>');
                        }
                    }
                })
            })
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        if (res.status == 'success') {
                            ...
                            $(".city_info").html(all_city.length ? '' : '<span class="text-danger">{{ __("No city found for selected state!") }}</span>');
                        }
                    }
                })
            })
            ...
            function countries(page){
                $.ajax({
                    url:"{{ route('admin.influencer.paginate.data').'?page='}}" + page,
                    success:function(res){
            ...
            $(document).on('keyup','#string_search',function(){
                ...
                $.ajax({
                    url:"{{ route('admin.influencer.search') }}",
                    method:'GET',
