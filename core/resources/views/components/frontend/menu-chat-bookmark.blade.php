    ...
    <div class="navbar-right-item">
        @php
            $unseen_message_count = \App\Models\User::select('id')
                ...
                ->first();
        @endphp
        <a href="{{ route('client.live.chat') }}" class="navbar-right-chat position-relative reload_unseen_message_count">
                ...
                @foreach ($client_bookmarks as $bookmark)
                    <div class="bookmark-item">
                        @if ($bookmark->is_project_job === 'project')
                            @if (!empty($bookmark?->bookmark_project))
                                <a href="{{ route('shake.details', ['username' => $bookmark?->bookmark_project?->project_creator?->username, 'slug' => $bookmark?->bookmark_project?->slug]) }}"
                            ...
                            @endif
                        @else
                            @if (!empty($bookmark?->bookmark_job))
                            ...
                            @endif
                        @endif
                        <span class="bookmark-item-close remove_from_bookmark" data-identity = "{{ $bookmark->id }}"
