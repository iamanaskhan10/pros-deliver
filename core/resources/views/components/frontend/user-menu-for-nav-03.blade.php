        ...
        <div class="single-right-content">
            <div class="navbar-right-flex">
                ...
                @if (Auth::guard('web')->user()->user_type == 1)
                    ...
                    @php
                        if (
                            get_static_option('project_enable_disable') != 'disable' &&
                            get_static_option('job_enable_disable') != 'disable'
                        ) {
                            $client_bookmarks = \App\Models\Bookmark::where(
                                'user_id',
                            ...
                            $client_bookmarks = '';
                        } elseif (get_static_option('project_enable_disable') == 'disable') {
                            $client_bookmarks = \App\Models\Bookmark::whereHas('bookmark_job')
                                ->where('is_project_job', 'job')
                                ->where('user_id', Auth::guard('web')->user()->id)
                                ->get();
                        } elseif (get_static_option('job_enable_disable') == 'disable') {
                    ...
                    <div class="navbar-right-item">
                        @php
                            $unseen_message_count = \App\Models\User::select('id')
                                ->withCount([
                                    'client_unseen_message' => function ($q) {
                                ...
                                ->first();
                        @endphp
                        <a href="{{ route('client.live.chat') }}"
                            class="navbar-right-chat position-relative reload_unseen_message_count"> <i
                                class="fa-regular fa-comment-dots"></i>
                            @if ($unseen_message_count->client_unseen_message_count > 0)
                                <span
                                    class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">{{ $unseen_message_count->client_unseen_message_count ?? '' }}</span>
                            @endif
                        </a>
                    </div>
                                    ...
                                    <div class="bookmark-item">
                                        @if ($bookmark->is_project_job == 'project')
                                            <a href="{{ route('project.details', ['username' => $bookmark?->bookmark_project?->project_creator?->username, 'slug' => $bookmark?->bookmark_project?->slug]) }}"
                                                ...
                                                <span class="bookmark-header-icon"><i
                            ...
                            @else
                                <span class="navbar-right-notification-wrapper-list-item-content-title">
                                    <span class="bookmark-header">
                                        <span class="bookmark-header-icon"><i class="fa-regular fa-heart"></i></span>
                ...
                @else
                    @php
                        if (
                            ...
                            $freelancer_bookmarks = \App\Models\Bookmark::where(
                                'user_id',
                                Auth::guard('web')->user()->id,
                            )->get();
                        } elseif (
                    ...
                    <div class="navbar-right-item">
                        @php
                            $unseen_message_count = \App\Models\User::select('id')
                                ->withCount([
                                    'freelancer_unseen_message' => function ($q) {
                                ...
                                ->first();
                        @endphp
                        <a href="{{ route('influencer.live.chat') }}"
                            class="navbar-right-chat position-relative reload_unseen_message_count"> <i
                                class="fa-regular fa-comment-dots"></i>
                            @if ($unseen_message_count->freelancer_unseen_message_count > 0)
                                <span
                                    class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">{{ $unseen_message_count->freelancer_unseen_message_count ?? '' }}</span>
                            @endif
                        </a>
                    </div>
                    <div class="navbar-right-item bookmark_area position-relative">
                            ...
                            @if (!empty($freelancer_bookmarks) && $freelancer_bookmarks->count() > 0)
                                @foreach ($freelancer_bookmarks as $bookmark)
                                    <div class="bookmark-item">
                                        @if ($bookmark->is_project_job == 'project')
                                            <a href="{{ route('project.details', ['username' => $bookmark?->bookmark_project?->project_creator?->username, 'slug' => $bookmark?->bookmark_project?->slug]) }}"
                                                class="bookmark-item-para"> <span class="bookmark-header-icon"><i
                                                        class="fa-regular fa-heart"></i></span>
                                                {{ $bookmark?->bookmark_project?->title ?? '' }}
                                            </a>
                                        @else
                                        ...
                                        <span class="bookmark-item-close remove_from_bookmark"
                                            data-identity = "{{ $bookmark->id }}"
                                            data-route = "{{ route('influencer.bookmark.remove') }}">
                                            <i class="fas fa-times"></i>
                                        </span>
                                    </div>
                                @endforeach
                                            ...
                                            <span href="javascript:void(0)"
                                                ...
                                                <div class="navbar-right-notification-wrapper-list-item-content">
                                                    ...
                                                    @if ($notification->type == 'Ticket Update')
                                                        <a
                                                            href="{{ route('client.ticket.details', $notification->identity) }}">
                                                            <span
                                                                class="navbar-right-notification-wrapper-list-item-content-title">{{ $notification->message }}</span>
                                                        </a>
                                                        <span
                        ...
                        <div class="navbar-right-notification">
                            <a href="javascript:void(0)" class="navbar-right-notification-icon">
                                ...
                                @if ($freelancer_notifications->count() > 0)
                                    <span
                                        class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">{{ $freelancer_notifications->count() ?? 0 }}</span>
                                @endif
                            </a>
                            <div class="navbar-right-notification-wrapper">
                                <div class="navbar-right-notification-wrapper-list">
                                        ...
                                        @foreach ($freelancer_notifications as $notification)
                                            <span href="javascript:void(0)"
                                                ...
                                                <div class="navbar-right-notification-wrapper-list-item-content">
                                                    ...
                                                    @if ($notification->type == 'Order')
                                                        <a
                                                            href="{{ route('influencer.order.details', $notification->identity) }}">
                                                            <span
                                                                class="navbar-right-notification-wrapper-list-item-content-title">{{ $notification->message }}</span>
                                                        </a>
                                                        <span
                                                    ...
                                                    @if ($notification->type == 'Withdraw')
                                                        <a href="{{ route('influencer.wallet.history') }}">
                                                            <span
                                                                class="navbar-right-notification-wrapper-list-item-content-title">{{ $notification->message }}</span>
                                                        </a>
                                                        <span
                                                    ...
                                                    @if ($notification->type == 'Reject Project')
                                                        <a
                                                            href="{{ route('influencer.profile.details', Auth::guard('web')->user()->username) }}">
                                                            <span
                                                                class="navbar-right-notification-wrapper-list-item-content-title">{{ $notification->message }}</span>
                                                        </a>
                                                        <span
                                                    ...
                                                    @if ($notification->type == 'Ticket Update')
                                                        <a
                                                            href="{{ route('influencer.ticket.details', $notification->identity) }}">
                                                            <span
                                                                class="navbar-right-notification-wrapper-list-item-content-title">{{ $notification->message }}</span>
                                                        </a>
                                                        <span
                            ...
                            <div class="navbar-author-thumb">
                                @if (Auth::user()->image)
                                    @if (cloudStorageExist() && in_array(Storage::getDefaultDriver(), ['s3', 'cloudFlareR2', 'wasabi']))
                                        <img src="{{ render_frontend_cloud_image_if_module_exists('profile/' . Auth::user()->image, load_from: Auth::user()->load_from) }}"
                                            alt="{{ __('profile img') }}">
                                    @else
                        ...
                        <div class="navbar-author-wrapper">
                            <div class="navbar-author-wrapper-list">
                                ...
                                @else
                                    ...
                                    <a href="{{ route('influencer.profile.details', Auth::guard('web')->user()->username) }}"
                                        class="navbar-author-wrapper-list-item">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                    ...
                                    <a href="{{ route('influencer.order.all') }}"
                                        class="navbar-author-wrapper-list-item">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                    ...
                                    <a href="{{ route('influencer.offers') }}"
                                        class="navbar-author-wrapper-list-item">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                    ...
                                    <a href="{{ route('influencer.proposal') }}"
                                        class="navbar-author-wrapper-list-item">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                    ...
                                    <a href="{{ route('influencer.logout') }}"
                                        class="navbar-author-wrapper-list-item">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
...
@else
    <div class="navbar-right-content show-nav-content navbar-four">
        <div class="single-right-content">
            <div class="navbar-right-flex">
                <div class="navbar-right-item position-relative">
                    <a href="#0" class="navbar-right-chat search-header-open cmn-btn btn-login search">
                        <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-zoom"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M10 10m-7 0a7 7 0 1 0 14 0a7 7 0 1 0 -14 0" /><path d="M21 21l-6 -6" /></svg>
                    </a>
                    <div class="header-global-search">
                        <div class="header-global-search-header">
                ...
                <div class="navbar-right-btn">
                    <a href="{{ route('user.login') }}"
                        class="cmn-btn btn-login btn-outline-1 color-one btn-small radius-10">{{ __('Log In') }}
                    </a>
                </div>
                <div class="btn-wrapper">
                    <a href="{{ route('user.register') }}"
                        class="cmn-btn btn-bg-1 btn-small radius-10 btn-orange">{{ __('Sign Up') }}
                    </a>
                </div>
            </div>
        </div>
